...
def get_args(args):
    ...
    parser.add_argument("-e", "--express",required=True, help="Path of the input gene expression matrix file")
    parser.add_argument("-p", "--phe",required=True, help="Path of the input phenotype file")
    parser.add_argument("-l", "--loci",required=True, help="Path of the gene loci file in bed format with 5 Colums")
